...
export default function AdminUsersPage() {
   ...
   * `registrarResposta` é o que responde "o token foi aceito?": lista vazia não
   * responde, porque "nenhum resultado" e "nunca carregou" são o mesmo array.
   */
   ...
   * lido — sem ele, "informe o token admin" piscava a cada carregamento.
   */
  useEffect(() => {
     ...
     */
    queueMicrotask(() => void loadUsers(token));
